    ...
    <div class="container mx-auto max-w-7xl px-4 py-8">
      <header class="mb-10 rounded-2xl bg-white p-6 shadow-lg">
        ...
        <p class="text-lg text-slate-600">
          Интерактивный урок по оптимизации рендеринга: `:key`, `v-once`, lazy loading, `v-memo` и
          `Suspense`.
        </p>
      </header>
          ...
          <section>
            ...
            <div class="flex flex-wrap gap-2 text-sm">
              ...
              <span class="rounded-full bg-cyan-100 px-3 py-1 text-cyan-800"
                ><code>v-once</code></span
              >
              <span class="rounded-full bg-lime-100 px-3 py-1 text-lime-800"
                ><code>v-memo</code></span
              >
              <span class="rounded-full bg-amber-100 px-3 py-1 text-amber-800"
                ><code>Suspense</code></span
              >
              <span class="rounded-full bg-indigo-100 px-3 py-1 text-indigo-800"
                ><code>defineAsyncComponent</code></span
              >
            </div>
          </section>
        </div>
