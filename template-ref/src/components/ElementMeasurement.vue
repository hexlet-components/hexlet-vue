          ...
          <div class="mb-4">
            ...
            >
              <p class="text-blue-800">
                Этот элемент измеряется через template ref. Его размеры можно получить с помощью
                getBoundingClientRect() и других свойств DOM.
              </p>
            </div>
            ...
            <div class="space-y-2 mb-4">
              ...
              <div class="flex justify-between">
                ...
                <span
                  class="font-medium"
                  :class="
                    textMetrics.scrollWidth > textMetrics.offsetWidth
                      ? 'text-red-600'
                      : 'text-green-600'
                  "
                >
      ...
      <div class="space-y-6">
        <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <h3 class="text-lg font-semibold text-gray-900 mb-4">
            Наблюдение за изменением размеров
          </h3>
          ...
          <div class="mb-4">
            ...
            >
              <p class="text-green-800">
                Этот элемент отслеживается ResizeObserver. При изменении его размеров метрики
          ...
          <div class="p-3 bg-yellow-50 rounded-lg">
            <p class="text-yellow-800 text-sm">
              ResizeObserver автоматически отслеживает изменения размеров элемента. Не забудьте
              отключить наблюдение в хуке onUnmounted.
            </p>
          </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <div class="p-3 bg-blue-50 rounded-lg">
            <p class="text-blue-800 text-sm">
              Метрики viewport обновляются при изменении размера окна и прокрутке. Используйте для
              адаптивного дизайна и отслеживания положения элементов.
            </p>
          </div>
        </div>
