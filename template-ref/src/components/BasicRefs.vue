          ...
          <div class="mb-4">
            ...
            <div class="mt-3 p-3 bg-gray-50 rounded-lg">
              ...
              <p class="text-gray-600 text-sm mt-1">
                При скрытии элемента ref становится
                <code class="bg-gray-100 px-1 rounded">null</code>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <div class="p-3 bg-purple-50 rounded-lg">
            <p class="text-purple-800 text-sm">
              Функция ref в v-for получает элемент и его индекс. Все refs хранятся в массиве для
          ...
          <div class="space-y-3">
            <div class="flex items-start">
              ...
              <div class="ml-3">
                ...
                <p class="text-gray-600 text-sm">DOM ещё не существует при создании компонента</p>
              </div>
            </div>
