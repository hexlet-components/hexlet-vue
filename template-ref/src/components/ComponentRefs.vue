        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <div class="p-3 bg-blue-50 rounded-lg">
            <p class="text-blue-800 text-sm">
              Template ref на компонент даёт доступ к его публичным методам и свойствам через
              <code class="bg-blue-100 px-1 rounded">defineExpose</code>.
            </p>
          </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <div class="p-3 bg-purple-50 rounded-lg">
            <p class="text-purple-800 text-sm">
              Ref можно установить динамически через функцию, которая получает экземпляр компонента
              как аргумент.
            </p>
          </div>
        </div>
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-start p-3 bg-green-50 rounded-lg">
              ...
              <div class="ml-3">
                ...
                <p class="text-green-600 text-sm">Идеально для передачи в сторонние библиотеки</p>
              </div>
            </div>
          </div>
        </div>
