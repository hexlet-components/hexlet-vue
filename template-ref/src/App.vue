  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="container mx-auto px-4 py-8 max-w-7xl">
      <header class="mb-10 text-center">
        <h1 class="text-4xl font-bold text-gray-800 mb-4">Работа с DOM через ref в Vue</h1>
        <p class="text-lg text-gray-600 max-w-3xl mx-auto">
          Практическая демонстрация template refs для доступа к DOM элементам, управления фокусом,
          измерения размеров и интеграции с нативными API
        </p>
      </header>
      ...
      <footer class="mt-12 pt-8 border-t border-gray-200">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 class="text-xl font-semibold text-gray-800 mb-4">Ключевые концепции</h3>
            <div class="space-y-2">
          ...
          <div>
            <h3 class="text-xl font-semibold text-gray-800 mb-4">Что демонстрируется</h3>
            <p class="text-gray-600 mb-4">
              Каждая вкладка показывает конкретный сценарий использования template refs. Все примеры
              интерактивны — вы можете взаимодействовать с элементами и видеть результаты в реальном
              времени.
            </p>
