          ...
          <div class="space-y-2">
            <div
              ...
              :class="[
                ...
                component.level === 5 ? 'border-l-green-500' : 'border-l-blue-500',
              ]"
            >
              ...
              <div
                v-if="component.level > 0 && component.level < 5"
          ...
          <div class="space-y-2">
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <span
                  v-else
                  class="text-sm px-2 py-1 rounded opacity-50"
