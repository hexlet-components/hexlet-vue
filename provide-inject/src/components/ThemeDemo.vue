    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div class="space-y-6">
        ...
        >
          ...
          <div class="p-4 rounded-lg" :class="theme === 'dark' ? 'bg-gray-800' : 'bg-gray-100'">
        ...
        >
          ...
          <div class="flex items-center space-x-4 mb-4">
            <div
              class="h-12 w-12 rounded-full flex items-center justify-center text-lg font-bold"
      ...
      <div class="space-y-6">
        ...
        >
          ...
          <div class="space-y-3">
            <button
              @click="
                openModal(
                  ...
                  'Это модальное окно открыто через контекст provide/inject. Любой компонент может открыть модалку без прямого доступа к родителю.',
                )
              "
            ...
            <p class="text-sm opacity-80">
              Модальное окно управляется через глобальный контекст. Любой компонент может открыть
              его без передачи callbacks через props.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <p class="text-sm mb-2">
            <code class="font-mono bg-black bg-opacity-30 px-2 py-1 rounded">App.vue</code>
            предоставляет тему:
          </p>
...
provide('toggleTheme', toggleTheme) // и функцию</pre>
        ...
        <div>
          <p class="text-sm mb-2">Любой компонент получает тему:</p>
          <pre class="text-xs bg-black bg-opacity-30 p-3 rounded overflow-x-auto">
