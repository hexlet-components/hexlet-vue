  ...
  <div>
    ...
    >
      ...
      <TabsContainer>
        <!-- Панель вкладок -->
        <div
          class="flex space-x-1 border-b mb-6"
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        ...
        <p class="text-sm mb-3">
          TabsContainer предоставляет контекст через provide. TabButton и TabContent получают его
          через inject.
        </p>
      ...
      >
        ...
        <ul class="space-y-2 text-sm">
          <li class="flex items-start">
            <span
              class="w-5 h-5 rounded-full bg-green-100 text-green-800 flex items-center justify-center text-xs mr-2 mt-0.5"
              >✓</span
            >
