          ...
          <div class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <div class="font-bold" :class="formState.submitting ? 'text-yellow-600' : ''">
              ...
              >
                ...
                <div class="font-bold" :class="formState.disabled ? 'text-green-600' : ''">
            ...
            <div v-if="Object.keys(formState.errors).length > 0">
              ...
              <ul class="space-y-1">
                <li
                  v-for="(error, field) in formState.errors"
                  :key="field"
            ...
            <div>
              ...
              <pre
                class="text-xs p-3 rounded overflow-x-auto"
