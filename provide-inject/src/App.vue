...
<template>
  ...
  >
    <div class="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <!-- Контент -->
      <main
        class="rounded-2xl shadow-xl p-6 transition-all duration-300"
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p class="opacity-80">
              Каждая демонстрация показывает реальный сценарий использования provide/inject для
              передачи данных через уровни вложенности без prop drilling.
            </p>
          </div>
          <div>
