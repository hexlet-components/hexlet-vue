    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      ...
      <div class="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-6">
        ...
        <p class="text-gray-700 mb-6">
          <span class="font-semibold text-blue-700">Параллельная загрузка</span> выполняется
          быстрее, так как запросы выполняются одновременно с помощью Promise.all().
          <span class="font-semibold text-gray-700">Последовательная загрузка</span> ждёт завершения
          каждого запроса перед началом следующего.
        </p>
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900">
                {{ executionTime.toFixed(2) }} <span class="text-sm">мс</span>
              </p>
            </div>
            <div class="text-right">
              ...
              <p
                ...
                :class="executionTime < 500 ? 'text-green-600' : 'text-yellow-600'"
              >
          ...
          <div>
            ...
            <div class="w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                :style="{ width: `${(stats.users / 10) * 100}%` }"
              ></div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                :style="{ width: `${(stats.posts / 10) * 100}%` }"
              ></div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                :style="{ width: `${(stats.comments / 10) * 100}%` }"
              ></div>
            </div>
          </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      ...
      <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          ...
          <h4 class="text-lg font-semibold text-white flex items-center gap-2">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                stroke-width="2"
                d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-1.205a6 6 0 01-7.143 0"
              />
            </svg>
        ...
        <div class="p-4 max-h-96 overflow-y-auto">
          ...
          <div
            v-if="users.length > 5 && !loadingUsers"
            class="text-center pt-3 border-t border-gray-200"
          >
      ...
      <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="p-4 max-h-96 overflow-y-auto">
          ...
          <div v-if="loadingComments" class="text-center py-8">
            <div
              class="inline-block animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-yellow-600"
            ></div>
        ...
        <div class="flex items-start space-x-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600">
              Параллельная загрузка значительно быстрее последовательной
            </p>
          </div>
        </div>
