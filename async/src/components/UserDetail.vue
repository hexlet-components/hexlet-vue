      ...
      <div class="lg:col-span-1 space-y-6">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
          ...
          <div class="mb-6">
            ...
            <p class="text-xs text-gray-500 mt-1">Введите 999 для симуляции ошибки 404</p>
          </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
          ...
          >
            <div class="flex-shrink-0">
              <div
                class="animate-spin rounded-full h-6 w-6 border-t-2 border-b-2 border-yellow-600"
              ></div>
            </div>
            <div class="ml-3">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          <div class="p-6">
            ...
            <div v-if="loading" class="text-center py-12">
              <div
                class="inline-block animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-blue-600"
              ></div>
              ...
              <div
                class="mt-4 inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-lg"
              >
            ...
            <div v-else-if="error" class="py-12">
              <div class="text-center">
                ...
                <div
                  class="inline-flex items-center px-4 py-2 bg-red-100 text-red-800 rounded-lg mb-6"
                >
            ...
            <div v-else-if="user" class="space-y-6">
              ...
              <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                <div class="flex-shrink-0">
                  <div
                    class="h-24 w-24 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-3xl"
                  >
                    {{ user.name.charAt(0) }}
                  </div>
                </div>
            ...
            <div v-else class="text-center py-12">
              ...
              <p class="text-gray-600">
                Выберите ID пользователя и нажмите "Загрузить пользователя"
              </p>
            </div>
          </div>
        </div>
